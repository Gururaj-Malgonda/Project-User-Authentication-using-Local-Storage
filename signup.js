...
const confirmPasswordInput = document.getElementById("userCnfPass");
...
confirmPasswordInput.addEventListener("input", (event) => {
  ...
  if (event.target.value !== passwordInput.value) {
    passwordMatchMessage.innerHTML = `Password is not matching`;
...
passwordInput.addEventListener("input", (event) => {
  if (event.target.value) {
    ...
    confirmPasswordInput.placeholder =
      "disabled( will be active after put value to password field)";
